...
The model combines historical financial data, operating assumptions,
supporting schedules, scenario analysis, financial ratio analysis,
cash-flow forecasting, model checks, and a management-style dashboard.
...
Key metrics include Revenue, COGS, Gross Profit, Operating Expenses,
EBITDA, D&A, EBIT, Interest Expense, EBT, Taxes, and Net Income.

The forecast uses scenario-driven operating assumptions, including
...
Operating cash flow incorporates EBITDA, interest, taxes,
working-capital movements, provisions, and other operating
assets/liabilities.

Investing cash flow includes capital expenditure.

Financing cash flow incorporates dividends, changes in financial
liabilities, and equity movements.
...
The selector allows the user to assess how different operating
...
change operating scenarios and assess the resulting impact on
